...
public class BackGroundWritable implements WritableComparable<BackGroundWritable> {
    ...
    public BackGroundWritable(String user,double tox, int upvotes, double rscore, String location, int commentcount,String like, ArrayList<Subreddits> subreddits){
    ...
    public String makeJson(){
        ...
        jsonArray.put(subreddits.toArray());
    ...
    public String readable(){
        return "____________________________________________\n" +
                "User: " + user +
                "Average upvotes: " + Double.toString((double) upvotes.get()/(double)commentcount.get()) + "\n" +
                "Education level: " +  Double.toString(readability_score.get()/(double)commentcount.get()) + "\n" +
                "Toxic Level: " +  Double.toString(toxic_score.get()/(double)commentcount.get())  + "\n" +

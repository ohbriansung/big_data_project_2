 ...
 */
public class BirthdaySampleJob {
  public static void main(String[] args) {
    try {
      ...
      job.setJarByClass(BirthdaySampleJob.class);

      /* Mapper */
      job.setMapperClass(BirthdaySampleMapper.class);
  ...
  private static class BirthdaySampleMapper extends Mapper<LongWritable, Text, Text, NullWritable> {
    private NullWritable out = NullWritable.get();
    private Random rand = new Random();

    public BirthdaySampleMapper() {}
